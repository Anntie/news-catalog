...
class AppAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function __construct(EntityManagerInterface $entityManager, UserPasswordEncoderInterface $encoder, UrlGeneratorInterface $urlGenerator, CsrfTokenManagerInterface $csrfTokenManager)
    {
